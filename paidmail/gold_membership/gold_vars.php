<?
       ...
       //paths to folders
       $gold_url="http://www.digitalvisionscripts.com/paidmail/gold_membership"; 
  //virtual path of the site folder    
       $gold_path="/home/dvscript/public_html/paidmail/gold_membership";  
//physical path of the site folder  $sitepath
       ...
       $from_email_id_for_regn="sales\@YourSiteName.com";
