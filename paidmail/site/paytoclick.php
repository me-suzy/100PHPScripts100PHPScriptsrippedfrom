...
if($res = mysql_query ($query1))
{
	...
	{
	    print "<p><font face='arial' size='2'>Welcome to the Paid-to-Click! You will be paid for clicks on the banners below and to view the advertiser's web site. Each banner displays the amount you will earn for clicking on it. 1.00 means 1 cent and 0.5 means 1/2 cent!</font></p>";
