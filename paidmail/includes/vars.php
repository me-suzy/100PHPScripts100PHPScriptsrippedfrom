<?
       $admin_mail_id="webmaster@digitalvisionscripts.com";   //Site Admin's email adds. for contact

       //paths to folders
       $url="http://www.digitalvisionscripts.com/paidmail";
       $path="/home/dvscript/public_html/paidmail";

       $site_url="$url/site";   //virtual path of the site folder       
       $site_path="$path/site";   //physical path of the site folder  
       $siteadds="www.digitalvisionscripts.com";   //site address
       $sitename="YourSiteName";   //site name

       $dbhost = "localhost";   //Host of the DataBase
       $dbname = "dvscript_mail";   //DB Name
       $dbuser = "dvscript_david";   //DB user name
       $dbpwd = "20007474";    //DB user password
