...
<form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  ...
  <!---  <tr> 
    ...
    <tr> 
      ...
      <td class="smallstatsText"><input type="hidden" name="textfield" value="<?php echo $row_Recordset1['username']; ?>"><input name="textfield2" type="text" value="<?php echo $row_Recordset1['password']; ?>" size="40"></td>
    </tr>
    <tr> 
      <td class="smallstatsText">&nbsp;</td>
