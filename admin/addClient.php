...
if ((isset($HTTP_POST_VARS["MM_insert"])) && ($HTTP_POST_VARS["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO banner_clients (client_name, contact_email, contact_phone, date_joined) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "mainTemplate.php?option=7";
  if (isset($HTTP_SERVER_VARS['QUERY_STRING'])) {
            ...
            <form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
              <table width="100%" border="0" cellpadding="4" cellspacing="0" class="supermenuNoshadow">
                ...
                <tr class="smallstatsText"> 
                  ...
                  <td valign="top"> <input name="client_name" type="text" id="client_name" maxlength="255"></td>
                </tr>
                <tr class="smallstatsText"> 
                  <td align="right" valign="top">contact 
                    email: </td>
                  <td valign="top"> <input name="contact_email" type="text" id="contact_email" maxlength="255"></td>
                </tr>
                <tr class="smallstatsText"> 
                  <td align="right" valign="top">contact 
                    phone :</td>
                  <td valign="top"> <input name="contact_phone" type="text" id="contact_phone" maxlength="20"></td>
                </tr>
                <tr class="smallstatsText"> 
                  <td align="right" valign="top">date joined:</td>
                  <td valign="top"> <input name="date_joined" type="text" value="<?php print date("Y\-m\-d"); ?>" id="date_joined"></td>
                </tr>
                <tr class="smallstatsText"> 
