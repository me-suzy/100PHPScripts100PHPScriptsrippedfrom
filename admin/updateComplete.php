  ...
  <tr> 
    <td width="800"> <table width="100%" border="0" align="center" cellpadding="4">
        <tr> 
          ...
          <td width="61%" align="center" valign="top" class="supermenuNoshadow"> 
            <p class="menuheader"><strong>Update Complete!</strong></p>
            <p><font color="#CCCCCC"><span class="smallstatsText"><a href="mainTemplate.php?option=XXXX"> 
              &lt;&lt;back to main menu</a></span><br>
              </font></p>
            </TD>
